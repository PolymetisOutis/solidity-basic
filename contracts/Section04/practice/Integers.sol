...
contract Integers {
   ...
   int8 public iBiotOpe1 = int8(12) & int8(7);

   // OR : 両方のビットのどちらかが1の場合に1
   int8 public iBiotOpe2 = int8(12) | int8(7);

   // XOR : ビットの値が異なる場合にだけ1
   int8 public iBiotOpe3 = int8(12) ^ int8(7);

   // NOT : ビット反転
   int8 public iBiotOpe4 = ~int8(12);
